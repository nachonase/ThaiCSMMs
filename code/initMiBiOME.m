...
[translatedAbundances,normalizedAbundances,unmappedRows] = translateMetagenome2AGORA('mos.txt','Species');
...
createPanModels(modPath,panPath,taxonLevel,agoraVersion,numWorkers);
%% 
